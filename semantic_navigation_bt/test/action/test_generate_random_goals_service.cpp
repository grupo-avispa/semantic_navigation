...
public:
  ...
  {
    node_ = std::make_shared<nav2::LifecycleNode>("generate_random_goals_test_fixture");
...
nav2::LifecycleNode::SharedPtr GenerateRandomGoalsServiceTestFixture::node_ = nullptr;
