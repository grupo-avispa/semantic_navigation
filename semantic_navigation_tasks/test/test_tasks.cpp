...
public:
  ...
  {
    SemanticNavigationTasks::getRandomRegionService(
      std::make_shared<rmw_request_id_t>(), request, response);
  }
...
TEST(SemanticNavigationTasksTest, configure) {
  ...
  std::string pkg = ament_index_cpp::get_package_share_path("semantic_navigation_tasks").string();
...
TEST(SemanticNavigationTasksTest, getConnectionsFromFile) {
  ...
  std::string pkg_path =
    ament_index_cpp::get_package_share_path("semantic_navigation_tasks").string();
